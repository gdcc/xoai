...
public interface Verb extends XmlWritable {
    ...
    enum Type {
        ...
        Type(
                ...
                Set<Argument> optional,
                Set<Argument> exclusive) {
            this.verb = value;
        ...
        public static Type from(String verb) throws BadVerbException {
            for (Type c : Type.values()) if (c.verb.equals(verb)) return c;
        ...
        /**
         * Return a set of Arguments that are mutually exclusive. If one of these is used, nothing
         * else may be present beside the "verb"
         *
    ...
    enum Argument {
        ...
        public static Argument from(String representation) throws BadArgumentException {
            for (Argument param : Argument.values())
                if (param.representation.equals(representation)) return param;
