...
public class ListRecordsHandlerTest extends AbstractHandlerTest {
    private final ListRecordsHandler underTest =
            new ListRecordsHandler(aContext(), theRepository());
    ...
    void responseWithItemHavingMetadataAttributes() throws Exception {
        ...
        ListRecords handle =
                underTest.handle(
                        new ResumptionToken.ValueBuilder().withMetadataPrefix("custom").build());
