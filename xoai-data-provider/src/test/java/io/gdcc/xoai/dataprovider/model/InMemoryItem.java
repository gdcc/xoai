...
public class InMemoryItem implements Item {
    ...
    public static InMemoryItem randomItem() {
        ...
        return item.with("identifier", randomAlphabetic(10))
    ...
    private static XOAIMetadata generateXoaiMetadata(Map<String, Object> values) {
        ...
        for (String key : values.keySet()) {
            ...
            if (value instanceof String) elementBuilder.withField(key, (String) value);
            else if (value instanceof Instant) elementBuilder.withField(key, value.toString());
            else if (value instanceof List) {
                List<String> obj = (List<String>) value;
                int i = 1;
                for (String e : obj) elementBuilder.withField(key + (i++), e);
            }
