 ...
 *
 * <p>Source copied from
 * https://github.com/mwiesiolek/inbot-utils/blob/master/src/main/java/io/inbot/utils/ReplacingInputStream.java
 * Originally licensed under MIT license Slightly adapted to avoid Apache Commons Lang3 dependency
 *
 * @author jillesvangurp
 * @deprecated This should not be used anywhere - it's very slow and of limited use for XOAI. It's
 *     solely used for benchmarking.
 */
...
public class ReplacingInputStream extends FilterInputStream {
    ...
    /**
     * Replace occurances of pattern in the input. Note: input is assumed to be UTF-8 encoded. If
     * not the case use byte[] based pattern and replacement.
     *
     * @param in input
    ...
    public ReplacingInputStream(InputStream in, String pattern, String replacement) {
        this(
                ...
                replacement == null ? null : replacement.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        // copy of parent logic; we need to call our own read() instead of super.read(), which
        // delegates
        // instead of calling our read
        if (b == null) {
