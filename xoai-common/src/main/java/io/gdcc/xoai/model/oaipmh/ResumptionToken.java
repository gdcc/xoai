...
public final class ResumptionToken implements XmlWritable {
    ...
    public void write(XmlWriter writer) throws XmlWriteException {
        try {
            ...
            if (this.cursor != null) writer.writeAttribute("cursor", "" + this.cursor);
            if (this.value != null) writer.write(this.value);
     ...
     *
     * <p>Immutable object, can only be build via {@link ValueBuilder} or be used to create another
     * immutable object representing the next chunk sent to the client via {@link #next(long)}.
     */
    public static final class Value {
        ...
        /**
         * Create a new resumption token value from this token, given the count of items returned
         * with this answer to a client. The client is supposed to send this new token on the next
         * request.
         *
        ...
        public int hashCode() {
            return Objects.hash(
                    getOffset(), getSetSpec(), getFrom(), getUntil(), getMetadataPrefix());
        }
