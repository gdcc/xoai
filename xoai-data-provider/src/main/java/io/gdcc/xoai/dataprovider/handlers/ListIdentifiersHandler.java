...
public class ListIdentifiersHandler extends VerbHandler<ListIdentifiers> {
    ...
    @Override
    public ListIdentifiers handle(Request request) throws HandlerException {
        throw new InternalOAIException("Method ListIdentifiersHandler.handle not allowed without resumption token");
    }

    @Override
    public ListIdentifiers handle(Request request, ResumptionToken.Value token) throws HandlerException {
