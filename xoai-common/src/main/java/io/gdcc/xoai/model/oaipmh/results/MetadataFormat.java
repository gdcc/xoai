...
public class MetadataFormat implements XmlWritable {
    ...
    public void write(XmlWriter writer) throws XmlWriteException {
        if (metadataPrefix != null) writer.writeElement("metadataPrefix", metadataPrefix);
        if (schema != null) writer.writeElement("schema", schema);
        if (metadataNamespace != null) writer.writeElement("metadataNamespace", metadataNamespace);
    }
}
