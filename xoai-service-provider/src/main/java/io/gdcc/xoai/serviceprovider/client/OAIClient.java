...
public abstract class OAIClient {
    ...
    /**
     * Create a new OAIClient with this builder, allowing for precise configuration. Individual
     * builders may allow for extended configuration.
     *
     * <p>A default implementation based on JDK 11+ HTTP Client is sent your way via {@link
     * OAIClient#newBuilder()}.
     */
    public interface Builder {
        /**
         * The base HTTP(S) URL to reach the OAI-PMH endpoint of your data provider. Often shaped
         * like this: https://host.example.org/oai Request parameters are handled by the
         * implementation.
         *
         * @param baseUrl
        ...
        /**
         * Set the timeout for establishing new connections from a client (does not affect existing,
         * reused connections).
         *
         * @param timeout
         * @return A builder, ready for configuration and creating your {@link OAIClient}.
        ...
        /**
         * Set the timeout for each HTTP request of this client. Needs to be adapted to the servers
         * (data providers) capabilities, usually connected to the amount of data you are trying to
         * receive.
         *
         * <p>Recommended setting to avoid blocking forever, waiting for a response.
         *
        ...
        /**
         * Set the user agent of your HTTP requests to data providers to sth. you enjoy. Will be
         * used for every request of this client.
         *
         * @param userAgent A string to be used as user agent indication. Should reflect this is a
         *     harvester.
         * @return A builder, ready for configuration and creating your {@link OAIClient}.
         */
        ...
        /**
         * Some OAI-PMH endpoints might redirect you to some other URL. (In example HTTP redirects
         * to HTTPS, URL rewriting etc.) By enabling this, you tell the client to silently follow
         * and redirects instead of returning you with the 30x response you need to handle yourself.
         *
         * @return A builder, ready for configuration and creating your {@link OAIClient}.
         */
         ...
         */
        Builder withCustomHeaders(String... headers);
    ...
    /**
     * Receive a builder to create a new OAIClient, allowing to configure different aspects of the
     * client and underlying technology.
     *
    ...
    /**
     * Execute a query against the OAI-PMH server given when building this client via an {@link
     * Builder}.
     *
     * <p>Will throw an exception when the response is not successful (not HTTP 200), connection
     * could not be established or the response took longer then the timeout to arrive.
     *
